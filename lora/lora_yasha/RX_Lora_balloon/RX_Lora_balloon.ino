...
//      RH_RF95::printBuffer("Received: ", buf, len);
      ...
      uint16_t count = *(int*)(recieveVal + 24);
      uint16_t recive = *(int*)(recieveVal + 26);
      int16_t rssi = *(int*)(recieveVal + 28);
      int16_t snr = *(int*)(recieveVal + 30);
      ...
      uint16_t bat = *(int*)(recieveVal + 48);  
...
//      Serial.println((char*)buf);
      ...
      Serial.println((float)bat*2*3.3/1024); 
