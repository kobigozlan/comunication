...
//      RH_RF95::printBuffer("Received: ", recieveVal, len);
      ...
      int16_t bat = *(int16_t*)(recieveVal + 36);
      uint8_t ird_sig = *(uint8_t*)(recieveVal + 38);
      uint8_t hr = *(uint8_t*)(recieveVal + 39);
      uint8_t mn = *(uint8_t*)(recieveVal + 40);
      uint8_t se = *(uint8_t*)(recieveVal + 41);
...
//      Serial.println((char*)buf);
      ...
      Serial.print(" SNR: ");
      Serial.println(snr); 
//      Serial.print("iridium signal: ");
//      Serial.println(ird_sig);  
